...
compile() {
  ...
  cp $ROOT_DIR/.eslintrc $PROJECT_PATH/node_modules/rook
  babel $ROOT_DIR/src/ --presets es2015,stage-0,react --plugins transform-runtime --out-dir $PROJECT_PATH/node_modules/rook/lib > /dev/null
